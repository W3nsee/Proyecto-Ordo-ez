...
<form action="" method="post">
    <select name="idmodificar">
        <?php
           ...
           // Verificar si hay alumnos disponibles antes de mostrar la lista desplegable
           if($resultado->num_rows == 0) {
               echo "<option value='' disabled selected>No hay alumnos disponibles</option>";
           } else {
...
<form action="" method="post">
    ...
    <?php
    //recuperar datos de grado y grupo
    $obj = new contacto();
