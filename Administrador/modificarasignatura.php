...
if($resultado->num_rows == 0) {
    ...
    $obj_maestro = new contacto();
    $resultado_maestro = $obj_maestro->consultarmaestro();

    if($resultado_maestro->num_rows == 0) {
        echo "<h2>No hay ningún maestro registrado en la base de datos. De de alta un maestro para poder editar.</h2>";
    } else {
?>
