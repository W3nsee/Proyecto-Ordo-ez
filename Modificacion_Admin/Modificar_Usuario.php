...
<body class="body">
    ...
    <section>
        ...
        <div class="titulo">
            ...
            <h1 class="text-titulo">MODIFICAR DATOS DE USUARIO</h1>

        </div>

        <a href="Modificar_Usuario_grupos.php">

            <div class="opc_1">

                <h2 class="text_opc">Primer grado</h2>
        ...
        <a href="Modificar_Usuario_grupos.php">
            ...
            <div class="opc_2">
                ...
                <h2 class="text_opc">Segundo grado</h2>
        ...
        <a href="Modificar_Usuario_grupos.php">
            ...
            <div class="opc_3">
                ...
                <h2 class="text_opc">Tercer grado</h2>
