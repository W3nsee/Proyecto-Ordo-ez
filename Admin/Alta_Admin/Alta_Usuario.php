...
<head>
    ...
    <link rel="stylesheet" href="../Style/style_Alta_Usuario.css">
...
<body class="body">
    ...
    <section>
        ...
        <div class="titulo">
            ...
            <h1 class="text-titulo">ALTA DE USUARIO</h1>

        </div>

        <a href="Alta_Usuario_Alumno.php">

            <div class="opc_alumno">

                <h2 class="text_opc">Alumno</h2>

            </div>

        </a>

        <a href="Alta_Usuario_Maestro.php">

            <div class="opc_maestro">

                <h2 class="text_opc">Maestro</h2>
