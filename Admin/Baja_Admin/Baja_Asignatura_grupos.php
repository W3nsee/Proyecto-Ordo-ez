...
<body class="body">
    ...
    <nav>
        ...
        <div class="Menu">
            ...
            <a href="../Matricula_Admin/Matricualar_Alumno.php">
    ...
    <section>
        ...
        <div class="titulo">
            ...
            <h1 class="text-titulo">BAJA DE ASIGNATURA</h1>

        </div>

        <a href="Baja_Asignatura_grupos.php">

            <div class="opc_1">

                <h2 class="text_opc">Grupo A</h2>
